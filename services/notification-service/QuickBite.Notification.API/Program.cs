...
using QuickBite.Notification.Infrastructure.DependencyInjection;
...
// Infrastructure (DbContext via Npgsql, repository, service)
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Multi-channel notifications (in-app / email / SMS) for order, payment, promo, and delivery events."
    });
