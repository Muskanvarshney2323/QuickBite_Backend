...
using QuickBite.DeliveryAgent.Infrastructure.DependencyInjection;
...
// Infrastructure (DbContext via Npgsql, repositories, services, Order-Service stub)
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Delivery agent profiles, real-time location, availability, verification, assignment, completion and rating."
    });
