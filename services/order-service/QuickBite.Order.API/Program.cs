...
using QuickBite.Order.Infrastructure.DependencyInjection;
...
builder.Services.AddControllers()
    ...
    {
        // Allows frontend to send enum values like "UPI", "CARD", or "CASH_ON_DELIVERY".
...
// Infrastructure (DbContext via Npgsql, repositories, services, payment/delivery stubs)
...
builder.Services.AddSwaggerGen(options =>
{
    ...
    options.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        Version = "v1",
        Description = "Central order orchestration: placement, lifecycle, agent assignment, cancellation with refund, reorder."
    });
